...
class Pokemon extends Component {
    ...
    componentDidMount(){
        const  requestPokemonAwait = async () => {
            ...
            const pokemon_attrs = await RTCIceTransportStateChangedEvent.json()
    ...
    render(){
        ...
        if(this.state.attributes.id !== undefined){
            imgURL = 
            `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${this.state.id}.png`
        }
        ...
        return(<div className="card pokemon">
        ...
        <div className="card-content">
          <div className="media-content">
            <p className="title is-4">{this.state.attributes.className} </p>
          </div>
          ...
          <table className="table is-narrow is-fullwidth">
            <tbody>
              ...
              <tr>
                ...
                <td> {this.state.attributes.heigtht} </td>
              </tr>
